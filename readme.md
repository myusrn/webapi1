...
- netsh advfirewall firewall add rule name="IISExpress Listeners to Expose" dir=in protocol=tcp localport=&lt;csv list of tcp port allowed/enabled in windows firewall&gt; profile=private remoteip=localsubnet action=allow, e.g. netsh advfirewall firewall add rule name="IISExpress Listeners to Expose" dir=in protocol=tcp localport=7146,5038 profile=private remoteip=localsubnet action=allow & netsh advfirewall firewall show rule name="IISExpress Listeners to Expose" [ & netsh advfirewall firewall delete rule name="IISExpress Listeners to Expose" ]  
